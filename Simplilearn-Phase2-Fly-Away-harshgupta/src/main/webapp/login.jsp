	...
	<footer>
		<div class="row justify-content-center">
			<div class="col-md-5 text-center">
				...
				<p>
					<i class="fas fa-envelope-open-text pr-2 fa-2x text-success"></i>support@agarg2811.com
				</p>

			</div>

			<hr class="socket">
			<p>&copy; FlyAway, All Rights Reserved &nbsp Developed & Desinged By Aman Garg</p>
		</div>
	</footer>
